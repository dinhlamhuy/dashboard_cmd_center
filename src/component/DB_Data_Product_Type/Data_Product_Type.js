          ...
          <table className="table table-fixed flex justify-start  w-full border-separate border-spacing-y-1">
            <thead>
              <tr className="backdrop-brightness-125 bg-blue-700">
                ...
                <th className="text-sm text-white w-24 ">型体 MODEL NAME</th>
                ...
                <th className="text-sm text-white w-12  ">倉庫發料<br />SẢN LƯỢNG PHÁT HÀNG<br />KHO ĐẾ LỚN
                </th>
                ...
                listData.map((item, index) => {
                  return (
                    ...
                    >
                      ...
                      <td className=" text-base text-blue-300 text-left ">
                        {item.Model_Name}
                      </td>
