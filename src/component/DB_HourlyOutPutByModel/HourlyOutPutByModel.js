  ...
  return (
    <>
      <div className="   overflow-hidden">
        <p className="text-center text-white text-4xl font-bold py-4">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 h-full w-full ">
          <div className="flex justify-center ">
            <table className="table table-fixed flex justify-start border w-full">
              <thead>
                <tr>
                  <th className="text-sm  text-blue-300 w-36 text-left pl-3">{t('hourlyoutputbymodel.shoeModel')}</th>
                  <th className="text-sm text-blue-300 w-12 text-left pl-2">{t('hourlyoutputbymodel.Line')}</th>
                  <th className="text-sm text-blue-300 w-12 ">
              ...
              <tbody>
                {listHourlyOutput &&
                  listHourlyOutput.slice(0, 42).map((item, index) => {
                    const colortr = item.Line === "Total" ? "bg-gray-400" : "";
                    return (
                      <tr key={"sl" + index} className={`${colortr}`}>
                        <td className=" text-sm text-yellow-400 font-bold text-left pl-2 ">
                          {item.Model}
                        </td>
                        <td
                          className={` text-sm ${
