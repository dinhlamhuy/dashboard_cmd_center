...
const HomeScreen = () => {
  ...
  const getComponent = async (idScreen) => {
    await axios
      .post("http://192.168.32.82:8083/api/dashboard/getlistcomponent", {
  ...
  const addCompontAtScreen = async (option) => {
    ...
    await axios
      .post("http://192.168.32.82:8083/api/dashboard/insertcomponentscreen", data)
      .then((response) => {
  ...
  const swapScreen = async (id_screen1, id_screen2) => {
    ...
    await axios
      .post("http://192.168.32.82:8083/api/dashboard/swapscreen", data)
      .then((response) => {
        // console.log(response.data.data);
        getAPI();
        // setOpenModal(false);
  ...
  const getAPI = async () => {
    await axios
      .post("http://192.168.32.82:8083/api/dashboard/getlistscreen")
      .then((response) => {
        // console.log(response.data.data);
  ...
  useEffect(() => {
    ...
    getAPIcheck();
    socketRef.current = socketIOClient.connect('http://localhost:8083');
